// Sidebar / PageHeader / UploadFileCard for Amplify page
const Sidebar = ({ active = 'amp' }) => {
  const items = [
...
const PageHeader = () => (
  <div className="flex items-start justify-between mb-6">
    <div>
      <h1 className="text-[28px] font-semibold tracking-tight">음량 증폭</h1>
      <p className="text-fg-dim text-[14px] mt-1.5">파형을 확인하면서 gain을 조절하고 결과를 저장할 수 있습니다.</p>
    </div>
