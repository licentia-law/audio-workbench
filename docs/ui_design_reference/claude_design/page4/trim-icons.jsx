...
const Icon = ({ name, className = 'w-4 h-4', stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case 'skip-start': return (
      <svg {...common} fill="currentColor" stroke="none"><rect x="5" y="5" width="2" height="14" rx="1"/><path d="M20 5v14L9 12z"/></svg>
    );
    case 'skip-end': return (
      <svg {...common} fill="currentColor" stroke="none"><rect x="17" y="5" width="2" height="14" rx="1"/><path d="M4 5v14l11-7z"/></svg>
    );
