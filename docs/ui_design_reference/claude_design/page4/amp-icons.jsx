// Amplify page icons — superset of trim icons, with amp-specific glyphs
const Icon = ({ name, className = 'w-4 h-4', stroke = 1.6 }) => {
  ...
  switch (name) {
    ...
    case 'stop': return (
      <svg {...common} fill="currentColor" stroke="none"><rect x="6" y="6" width="12" height="12" rx="1.5"/></svg>
    );
    case 'download': return (
      <svg {...common}><path d="M12 4v12M7 11l5 5 5-5"/><path d="M5 20h14"/></svg>
    );
    case 'zoom-in': return (
      <svg {...common}><circle cx="11" cy="11" r="6"/><path d="M21 21l-5-5M11 8v6M8 11h6"/></svg>
    );
    case 'zoom-out': return (
      <svg {...common}><circle cx="11" cy="11" r="6"/><path d="M21 21l-5-5M8 11h6"/></svg>
    );
    case 'fit': return (
      <svg {...common}><path d="M4 9V5h4M20 9V5h-4M4 15v4h4M20 15v4h-4"/></svg>
    );
    case 'help': return (
    ...
    case 'volume-low': return (
      <svg {...common}><path d="M11 5 6 9H3v6h3l5 4z"/><path d="M16 10a3 3 0 0 1 0 4"/></svg>
    );
    case 'speaker': return (
    ...
    // amp-specific
    case 'sparkle': return (
      <svg {...common}><path d="M12 4v4M12 16v4M4 12h4M16 12h4M6 6l2.5 2.5M15.5 15.5 18 18M6 18l2.5-2.5M15.5 8.5 18 6"/></svg>
    );
    case 'shield': return (
      <svg {...common}><path d="M12 3 4 6v6c0 5 3.5 8 8 9 4.5-1 8-4 8-9V6z"/><path d="m9 12 2 2 4-4"/></svg>
    );
    case 'meter': return (
      <svg {...common}><path d="M3 17a9 9 0 0 1 18 0"/><path d="M12 17l5-4"/><circle cx="12" cy="17" r="1.4" fill="currentColor"/></svg>
    );
    case 'wave': return (
      <svg {...common}><path d="M3 12h2l2-6 3 12 3-9 2 6 2-3h4"/></svg>
    );
    default: return null;
  }
};
