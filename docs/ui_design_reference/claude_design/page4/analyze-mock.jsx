// Sidebar — same nav as page1 but active='analyze'
const Sidebar = ({ active = 'analyze' }) => {
  const items = [
...
const PageHeader = () => (
  <div className="flex items-start justify-between mb-6">
    <div>
      <h1 className="text-[28px] font-semibold tracking-tight">음원 분석</h1>
      <p className="text-fg-dim text-[14px] mt-1.5">업로드한 음원의 Key와 BPM을 참고용으로 분석합니다.</p>
    </div>
...
// Badge (kept identical to page1 token system)
...
// Upload + file meta card — same chrome as page1 but adds sample rate / bitrate / loudness
