...
type ActiveModal = 'guide' | 'settings' | 'contact' | null
      ...
      <aside className="w-[220px] shrink-0 border-r border-line bg-ink-850 flex flex-col">
        ...
        <div className="mt-auto px-3 pb-5 flex flex-col gap-0.5">
          <button
            ...
            className="flex items-center gap-3 px-3 h-9 rounded-md text-[13px] text-fg-mute hover:text-fg-dim hover:bg-ink-700/40 transition-colors w-full text-left"
          >
